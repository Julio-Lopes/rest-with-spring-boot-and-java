package br.integrationtests.controller.withjson;
...
public class PersonTest extends AbsIntTest {
	...
	void testCreate() throws JsonMappingException, JsonProcessingException {
		...
		specification = new RequestSpecBuilder()
			.addHeader(TestConfigs.HEADER_PARAM_ORIGIN, TestConfigs.ORIGIN_HOST)
	...
	void testCreateWithWrongOrigin() throws JsonMappingException, JsonProcessingException {
		...
		specification = new RequestSpecBuilder()
			.addHeader(TestConfigs.HEADER_PARAM_ORIGIN, TestConfigs.ORIGIN_BAN)
			.setBasePath("/api/person/v1")
			.setPort(TestConfigs.SERVER_PORT)
				.addFilter(new RequestLoggingFilter(LogDetail.ALL))
				.addFilter(new ResponseLoggingFilter(LogDetail.ALL))
